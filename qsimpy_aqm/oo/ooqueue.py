...
class OfflineOptimumQueue(SimpleQueue):
    ...
    def run(self) -> None:
        ...
        while True:
            ...
            # before poping the head of queue, OO algorithm kicks in
    ...
    def put(self, 
        ...
        if drop:
            ...
            task.__class__ = make_dataclass('OOGeneratedTimedTask', fields=[('oo_service_delay', float, field(default=-1))], bases=(task.__class__,))
